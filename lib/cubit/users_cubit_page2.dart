...
import 'package:userdetails/data/api_client.dart';
...
class UsersCubit extends Cubit<BaseState> {
  UsersCubit({ this.apiClient}) : super(InitialState()){
    getAllUserses();
  }
  ...
  void getAllUserses() async {
    ...
    try {
      emit(LoadingState());
      final result = await apiClient.getUsers(token);
